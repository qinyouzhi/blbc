...
function config(e,t){t.otherwise("/login"),e.state("login",{url:"/login",templateUrl:"viwes/login.html",controller:"sub"}).state("index",{url:"/index",templateUrl:"viwes/index.html"}).state("licai",{url:"/licai",templateUrl:"viwes/licai.html",controller:"renderLicai"}).state("find",{url:"/find",templateUrl:"viwes/find.html",controller:"renderFind"}).state("me",{url:"/me",templateUrl:"viwes/me.html"}).state("new_bie",{url:"/new_bie",templateUrl:"viwes/new_bie.html"}).state("safety",{url:"/safety",templateUrl:"viwes/safety.html"}).state("data",{url:"/data",templateUrl:"viwes/data.html"}).state("newbie_zx",{url:"/newbie_zx",templateUrl:"viwes/newbie_zx.html"}).state("vip_center",{url:"/vip_center",templateUrl:"viwes/vip_center.html"}).state("red_packet",{url:"/red_packet",templateUrl:"viwes/red_packet.html"}).state("investment",{url:"/investment",templateUrl:"viwes/investment.html"}).state("safety_twe",{url:"/safety_twe",templateUrl:"viwes/safety_twe.html"}).state("set",{url:"/set",templateUrl:"viwes/set.html"}).state("phone",{url:"/phone",templateUrl:"viwes/phone.html"}).state("email",{url:"/email",templateUrl:"viwes/email.html"}).state("bank",{url:"/bank",templateUrl:"viwes/bank.html"}).state("password",{url:"/password",templateUrl:"viwes/password.html"})}config.$inject=["$stateProvider","$urlRouterProvider"],angular.module("myapp").config(config);
function sub(n,e,i){n.submit=function(){var r=$("#username").val(),a=$("#userpwd").val();return""==r||""==a?(alert("请补全用户名或密码"),!1):void(/^1[34578]\d{9}$/.test(r)?i.login("http://localhost:3001/login",{username:n.username,userpwd:n.userpwd},"jsonp").success(function(n){1==n.code?alert("您输入的帐号或密码有误"):e.url("/index")}):alert("手机号码有误，请重填"))}}function renderLicai(n,e){var i=[];e.login("http://localhost:3001/licai",{username:"licai",userpwd:"666"},"jsonp").success(function(e){n.data=e,angular.forEach(n.data,function(n){i.push(n.num)})}),n.$on("ngRepeatFinished",function(n){new IScroll("#MoneyDv",{click:!0});for(var e=1,r=$(".canvas").length;e<=r;e++)drawCircle({id:"canvas"+e,color:"#FC1F1F",angle:i[e-1],lineCap:"round"})})}function renderFind(n,e){var i=[];e.login("http://localhost:3001/find",{username:"licai",userpwd:"666"},"jsonp").success(function(e){n.data=e,angular.forEach(n.data,function(n){i.push(n.num)})}),n.$on("ngRepeatFinished",function(n){var e=$(".pBg").length;new IScroll("#find",{click:!0});for(var r=0;r<e;r++)$("#pBg"+r).css({width:100*i[r]+"%",transition:"width .5s"})})}sub.$inject=["$scope","$location","apiService"],renderLicai.$inject=["$scope","apiService"],renderFind.$inject=["$scope","apiService"],angular.module("myapp").controller("sub",sub).controller("renderLicai",renderLicai).controller("renderFind",renderFind);
function ngIndex(){return{link:function(n,i){new IScroll("#list",{click:!0});new Swiper(".swiper-container",{loop:!0,autoplay:5e3,autoplayDisableOnInteraction:!1})}}}function ngLicai(n){return{restrict:"A",link:function(i,e,t){i.$last===!0&&n(function(){i.$emit("ngRepeatFinished")})}}}function ngFind(n){return{link:function(i,e){i.$last===!0&&n(function(){i.$emit("ngRepeatFinished")})}}}function ngMe(){return{link:function(n,i){new IScroll("#me",{click:!0})}}}function ngSafety(){return{link:function(n,i){new IScroll("#safety1",{click:!0}),new IScroll("#safety2",{click:!0}),new IScroll("#safety3",{click:!0}),new IScroll("#safety4",{click:!0}),new IScroll("#safety5",{click:!0});$("#navUl>li").on("tap",function(){var n=$(this).index();$("#safetyBook").css({transform:"translateX("+100*-n+"%)",transition:"transform .5s"}),$("#navFousP").css({left:20*n+"%",transition:"left .5s"})})}}}function redBao(){return{link:function(n,i){new IScroll("#redOne1",{click:!0}),new IScroll("#redOne2",{click:!0}),new IScroll("#redOne3",{click:!0});$("#uls").find("li").on("tap",function(){var n=$(this).index();$(this).addClass("bod").siblings().removeClass("bod"),$("#redBox").css({transform:"translateX("+100*-n+"%)",transition:"transform .5s"})})}}}function newbieFl(){return{link:function(n,i){new IScroll("#newDie",{click:!0})}}}function newBie(){return{link:function(n,i){new IScroll("#newbie",{click:!0})}}}function invesTment(){return{link:function(n,i){new IScroll("#investment",{click:!0})}}}function loadShow(){return{link:function(n,i){var e=!1;setTimeout(function(){$("#loadImg").css({"-webkit-transform":"scale(2)",opacity:"0","-webkit-transition":"all 2s"}),e=!0},2e3),setTimeout(function(){e&&$("#loadImg").hide()},4e3)}}}ngLicai.$inject=["$timeout"],ngFind.$inject=["$timeout"],angular.module("myapp").directive("ngIndex",ngIndex).directive("ngLicai",ngLicai).directive("ngFind",ngFind).directive("ngMe",ngMe).directive("redBao",redBao).directive("newBie",newBie).directive("newbieFl",newbieFl).directive("invesTment",invesTment).directive("loadShow",loadShow).directive("ngSafety",ngSafety);
function drawCircle(e){function l(e){r.putImageData(g,0,0),r.beginPath(),r.strokeStyle="grd"==n.color?c:n.color,r.arc(a,a,a-n.lineWidth,-i,d*e-i,!1),r.stroke()}function t(e){f=setInterval(function(){h>e?(l(n.angle),clearInterval(f)):(l(h),h+=.02)},20)}var n=e||{};n.angle=n.angle||1,n.color=n.color||"#fff",n.lineWidth=n.lineWidth||3,n.lineCap=n.lineCap||"square";var o=document.getElementById(n.id),a=o.width/2,r=o.getContext("2d"),i=Math.PI/2,d=2*Math.PI,c=r.createLinearGradient(0,0,o.width,0);c.addColorStop(0,"red"),c.addColorStop(.5,"yellow"),c.addColorStop(1,"green"),r.textAlign="center",r.font="normal normal bold  Arial",r.fillStyle="grd"==n.color?c:"#333",r.fillText(100*n.angle+"%",a,a+5),r.lineCap=n.lineCap,r.strokeStyle="grd"==n.color?c:n.color,r.lineWidth=n.lineWidth,r.beginPath(),r.strokeStyle="#D8D8D8",r.arc(a,a,a-n.lineWidth,-i,d,!1),r.stroke();var g=r.getImageData(0,0,240,240),h=0,f=null;t(n.angle),f=null}
var width=document.documentElement.clientWidth/7.5;document.documentElement.style.fontSize=width+"px";
